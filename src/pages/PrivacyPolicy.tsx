...
const PrivacyPolicy = () => {
  useEffect(() => {
    document.title = "Privacy Policy - Chrono";
  }, []);
        ...
        <div className="pt-24 pb-20 bg-gradient-to-b from-background via-secondary/5 to-background">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            >
              ...
              <h1 className="text-6xl lg:text-8xl xl:text-9xl font-black tracking-tighter mb-6">Privacy Policy</h1>
            ...
            >
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  At Chrono ("we," "our," or "us"), we respect your privacy and are committed to protecting your personal data. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website, make a purchase, or interact with our services.
                </p>
              </section>
